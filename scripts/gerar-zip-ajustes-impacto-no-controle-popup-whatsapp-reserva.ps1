...
# 1) popup inicial configurável por campanha
# 2) sequência até "Reservar números e gerar Pix"
# 3) página /reserva/[token]
# 4) envio/registro de link por WhatsApp
# 5) mensagens de obrigado/acompanhamento
# 6) validação de comprovante e duplicidade
# 7) valores/quantidade vindos do cadastro da campanha
$items = @(
  "package.json",
  "package-lock.json",
  ".npmrc",
